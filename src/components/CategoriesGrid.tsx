...
const cats = [
  { icon: Smartphone, label: "Electronics",   count: "2.4M+", from: "#6366f1", to: "#8b5cf6" },
  { icon: Laptop,     label: "Computers",     count: "890K+", from: "#0ea5e9", to: "#6366f1" },
  { icon: Shirt,      label: "Fashion",       count: "5.1M+", from: "#ec4899", to: "#f43f5e" },
  { icon: Home,       label: "Home & Garden", count: "3.2M+", from: "#10b981", to: "#059669" },
  { icon: Dumbbell,   label: "Sports",        count: "1.8M+", from: "#f97316", to: "#ef4444" },
  { icon: Gamepad2,   label: "Gaming",        count: "760K+", from: "#8b5cf6", to: "#6366f1" },
  { icon: Baby,       label: "Baby & Kids",   count: "1.1M+", from: "#f59e0b", to: "#f97316" },
  { icon: Car,        label: "Automotive",    count: "940K+", from: "#14b8a6", to: "#0ea5e9" },
  { icon: Watch,      label: "Watches",       count: "420K+", from: "#a78bfa", to: "#ec4899" },
  { icon: Headphones, label: "Audio",         count: "380K+", from: "#38bdf8", to: "#818cf8" },
  { icon: Camera,     label: "Photography",   count: "290K+", from: "#fb923c", to: "#f59e0b" },
  { icon: Gem,        label: "Jewelry",       count: "670K+", from: "#e879f9", to: "#a78bfa" },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3">
            Shop Every <span className="text-gradient">Category</span>
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
          {cats.map(({ icon: Icon, label, count, from, to }) => (
            <button
              key={label}
        ...
        <div className="text-center mt-8">
          <button className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white/[0.04] border border-white/[0.08] text-[#8888aa] text-sm hover:text-white hover:border-[#7c6fff]/40 hover:bg-[#7c6fff]/10 transition-all duration-200">
